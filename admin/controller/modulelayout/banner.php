...
class ControllerModulelayoutBanner extends Controller {
	...
	public function index() {
		...
		$this->load->language('modulelayout/banner');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('modulelayout/banner', 'token=' . $this->session->data['token'] . $url, true));
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('modulelayout/banner', 'token=' . $this->session->data['token'] . $url, true)
		...
		$data['add'] = $this->url->link('modulelayout/banner/add', 'token=' . $this->session->data['token'] . $url, true);


		$data['delete'] = $this->url->link('modulelayout/banner/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['banners'][] = array(
				...
				'edit'      => $this->url->link('modulelayout/banner/edit', 'token=' . $this->session->data['token'] . '&banner_id=' . $result['banner_id'] . $url, true)
		...
		$data['sort_name'] = $this->url->link('modulelayout/banner', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);


		$data['sort_status'] = $this->url->link('modulelayout/banner', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
		...
		$pagination->url = $this->url->link('modulelayout/banner', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('modulelayout/banner_list', $data));
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['banner_id'])) {
			...
			$data['action'] = $this->url->link('modulelayout/banner/add', 'token=' . $this->session->data['token'] . $url, true);


		} else {


			$data['action'] = $this->url->link('modulelayout/banner/edit', 'token=' . $this->session->data['token'] . '&banner_id=' . $this->request->get['banner_id'] . $url, true);
		...
		$data['cancel'] = $this->url->link('modulelayout/banner', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('modulelayout/banner_form', $data));
	...
	protected function validateForm() {
		...
		if (!$this->user->hasPermission('modify', 'modulelayout/banner')) {

          ...
          <div class="tab-content clearfix">
            <div class="tab-pane active" id="1a">
              ...
              <div class="tab-content">
                ...
                <div class="col-sm-10">
                  <input type="text" name="featurename[<?php echo $language['language_id']; ?>][name]" value="<?php if(isset($featurename[$language['language_id']]['name'])){echo $featurename[$language['language_id']]['name']; }?>" placeholder="<?php echo $entry_name;?>" id="input-name" class="form-control" />

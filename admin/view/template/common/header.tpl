...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
    <li class="dropdown hide"><a class="dropdown-toggle" data-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $alerts; ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
    ...
    <li class="dropdown hide"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-home fa-lg"></i></a>
    ...
    <li class="dropdown hide"><a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-life-ring fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right">
	...
	<li class="hide">
		<div class="search input-group">
			<input type="text" name="search" value="" class="form-control input-srch" />
			<span class="input-group-btn">
				<button type="button" class="btn btn-default btn-srch"><i class="fa fa-search"></i></button>
			</span>
		</div>
	</li>
	<!--static-->
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">
		...
		<ul class="dropdown-menu dropdown-menu-right">
			...
			<li><a href="<?php echo $store['href']; ?>" target="_blank"><?php echo $store['name']; ?></a></li>
			<?php }  ?>
			<li><a href="<?php echo $logout; ?>"><span class="hidden-xs hidden-sm hidden-md"></span> <?php echo $text_logout; ?> <i class="fa fa-sign-out fa-lg"></i></a></li>
		</ul>
		<?php } ?>
	</li>
  </ul>

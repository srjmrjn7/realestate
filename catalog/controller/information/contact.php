...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$data['text_getin'] = $this->language->get('text_getin');
	    ...
	    $data['emails'] = nl2br($this->config->get('config_email'));


	    $data['maps'] = $this->config->get('config_map');


	    $data['mapkey'] = nl2br($this->config->get('config_mapkey'));

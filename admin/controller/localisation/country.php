...
class ControllerLocalisationCountry extends Controller {
	...
	public function getList() {
		...
		if (isset($this->request->get['filter_name'])) {
            ...
            $filter_name = false;
				...
				if (isset($this->request->get['filter_iso_code2'])) {


            


            $filter_iso_code2 = $this->request->get['filter_iso_code2'];
        ...
        if (isset($this->request->get['page'])) {
			...
			//$url .= '&filter_name=' . $this->request->get['filter_name'];
				...
				if (isset($this->request->get['filter_iso_code2'])) {
						...
						$url .= '&filter_iso_code2=' . $this->request->get['filter_iso_code2'];
		...
		$filter_data = array(
			...
			'filter_iso_code2' =>$filter_iso_code2,
   ...
   $data['button_filter'] = $this->language->get('button_filter');
		...
		$data['filter_iso_code2']= $filter_iso_code2;
	...
	$data['text_yes'] = $this->language->get('text_yes');
		...
		$data['text_iso_code_2']        = $this->language->get('text_iso_code_2');
		$data['text_iso_code_3']        = $this->language->get('text_iso_code_3');
		$data['text_address_format']    = $this->language->get('text_address_format');
		$data['text_postcode_required'] = $this->language->get('text_postcode_required');

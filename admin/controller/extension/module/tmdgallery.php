	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (!isset($this->request->get['module_id'])) {
				...
				$this->model_extension_module->addModule('tmdgallery', $this->request->post);
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/tmdgallery', 'token=' . $this->session->data['token'], 'SSL')
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/tmdgallery', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['action'] = $this->url->link('extension/module/tmdgallery', 'token=' . $this->session->data['token'], 'SSL');
			...
			$data['action'] = $this->url->link('extension/module/tmdgallery', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');

...
class ControllerLocalisationCurrency extends Controller {
	...
	protected function getForm() {
		...
		$data['text_symbol_left'] = $this->language->get('text_symbol_left');


		$data['text_symbol_right'] = $this->language->get('text_symbol_right');


		$data['text_decimal_place'] = $this->language->get('text_decimal_place');

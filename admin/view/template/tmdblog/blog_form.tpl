        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-data">
			   ...
			   <div class="form-group">
                <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_username; ?></label>
                <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-blogcategory"><span data-toggle="tooltip" title="<?php echo $help_tmdblogcategory; ?>"><?php echo $entry_tmdblogcategory; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="blogcategory" value="" placeholder="<?php echo $entry_tmdblogcategory; ?>" id="input-blogcategory" class="form-control" />
                  <div id="blog-blogcategory" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($blog_categories as $blog_category) { ?>
                    <div id="blog-blogcategory<?php echo $blog_category['tmdblogcategory_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $blog_category['name']; ?>
                      <input type="hidden" name="blog_category[]" value="<?php echo $blog_category['tmdblogcategory_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_blogcoment; ?></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane fade" id="tab-comment">
				...
				<?php if($comments){?>
				 ...
				 <td class="right">[ <a style="cursor:pointer" onclick="deletecomment(<?php echo $comnt['comment_id']; ?> )">Delete</a> ]</td>
					...
					<?php } ?>
					<?php } else { ?>
					 <td class="text-center" colspan="4"><?php echo $text_no_comment; ?></td>
					<?php } ?>
				  </tbody>
				</table>
				</div>
...
function deletecomment(comment_id){
	if(comment_id){
		$.ajax({
		url: 'index.php?route=tmdblog/blog/deletecoment&token=<?php echo $token?>',
		type: 'get',
		...
		$('.success, .warning, .attention, information, .error').remove();
			...
			if (json['success']) {
					...
					$('.inserdata').load('index.php?route=tmdblog/blog/loadcomment&token=<?php echo $token ?>&blog_id=<?php echo $blog_id?>');	
			}

	...
	<div class="container-fluid">
		...
		<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-newssubscriber" class="form-horizontal">
			<div class="form-group required">
                <label class="col-sm-2 control-label" for="input-email_id"><?php echo $entry_code; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="email_id" value="<?php echo isset($email_id)?$email_id:''; ?>" placeholder="<?php echo $entry_code; ?>" id="email_id" class="form-control" />

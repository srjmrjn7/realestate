...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_admin_language'] = $this->language->get('text_admin_language');


		$data['text_currency'] = $this->language->get('text_currency');


		$data['text_currency_auto'] = $this->language->get('text_currency_auto');
		...
		$data['text_limit_admin'] = $this->language->get('text_limit_admin');


		$data['text_product_count'] = $this->language->get('text_product_count');


		$data['text_customer_online'] = $this->language->get('text_customer_online');


		$data['text_customer_activity'] = $this->language->get('text_customer_activity');


		$data['text_customer_search'] = $this->language->get('text_customer_search');


		$data['text_customer_group'] = $this->language->get('text_customer_group');


		$data['text_customer_group_display'] = $this->language->get('text_customer_group_display');


		$data['text_customer_price'] = $this->language->get('text_customer_price');


		$data['text_login_attempts'] = $this->language->get('text_login_attempts');
		...
		$data['text_captcha_page'] = $this->language->get('text_captcha_page');
		...
		$data['text_ftp_hostname'] = $this->language->get('text_ftp_hostname');


		$data['text_ftp_port'] = $this->language->get('text_ftp_port');


		$data['text_ftp_username'] = $this->language->get('text_ftp_username');


		$data['text_ftp_password'] = $this->language->get('text_ftp_password');


		$data['text_ftp_root'] = $this->language->get('text_ftp_root');


		$data['text_ftp_status'] = $this->language->get('text_ftp_status');


		$data['text_mail_protocol'] = $this->language->get('text_mail_protocol');


		$data['text_mail_parameter'] = $this->language->get('text_mail_parameter');


		$data['text_mail_smtp_hostname'] = $this->language->get('text_mail_smtp_hostname');


		$data['text_mail_smtp_username'] = $this->language->get('text_mail_smtp_username');


		$data['text_mail_smtp_password'] = $this->language->get('text_mail_smtp_password');


		$data['text_mail_smtp_port'] = $this->language->get('text_mail_smtp_port');


		$data['text_mail_smtp_timeout'] = $this->language->get('text_mail_smtp_timeout');


		$data['text_mail_alert'] = $this->language->get('text_mail_alert');


		$data['text_mail_alert_email'] = $this->language->get('text_mail_alert_email');
		...
		$data['text_shared'] = $this->language->get('text_shared');


		$data['text_robots'] = $this->language->get('text_robots');


		$data['text_file_max_size'] = $this->language->get('text_file_max_size');


		$data['text_file_ext_allowed'] = $this->language->get('text_file_ext_allowed');


		$data['text_file_mime_allowed'] = $this->language->get('text_file_mime_allowed');
		...
		$data['text_compression'] = $this->language->get('text_compression');


		$data['text_error_display'] = $this->language->get('text_error_display');


		$data['text_error_log'] = $this->language->get('text_error_log');


		$data['text_error_filename'] = $this->language->get('text_error_filename');

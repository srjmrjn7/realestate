...
class ModelAgentnewslettersubscribe extends Model {
	...
	public function subscribe($data){
	  	   ...
	  	   $this->db->query("INSERT INTO " . DB_PREFIX . "subscribe SET email_id='".$data['subscribe_email']."',option1='".$this->db->escape(isset($data['option1'])?$data['option1']:'')."',option2='".$this->db->escape(isset($data['option2'])?$data['option2']:'')."',option3='".$this->db->escape(isset($data['option3'])?$data['option3']:'')."',option4='".$this->db->escape(isset($data['option4'])?$data['option4']:'')."',option5='".$this->db->escape(isset($data['option5'])?$data['option5']:'')."',option6='".$this->db->escape(isset($data['option6'])?$data['option6']:'')."'");

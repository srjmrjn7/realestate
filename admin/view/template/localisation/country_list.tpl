      	 ...
      	 <div class="well">
              ...
              <div class="form-group">
                ...
                <input type="text" name="filter_name" value="<?php echo $filter_name;?>" placeholder="<?php echo $column_name; ?>" id="input-name" class="form-control" />
							...
							<div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-name"><?php echo $column_iso_code_2; ?></label>
                <input type="text" name="filter_iso_code2" value="<?php echo $filter_iso_code2;?>"placeholder="<?php echo $column_iso_code_2; ?>" id="input-name" class="form-control" />
              </div>
							...
							<div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-name"><?php echo $column_iso_code_3; ?></label>
                <input type="text" name="filter_iso_code_3" value="<?php echo $filter_iso_code_3;?>" placeholder="<?php echo $column_iso_code_3; ?>" id="input-name" class="form-control" />
              </div>
...
$('#button-filter').on('click', function() {
	...
	var filter_iso_code2 = $('input[name=\'filter_iso_code2\']').val();

	if (filter_iso_code2) {
		url += '&filter_iso_code2=' + encodeURIComponent(filter_iso_code2);
	}

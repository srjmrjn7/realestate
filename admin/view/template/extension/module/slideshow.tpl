      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="name" value="<?php echo $name; ?>" placeholder="<?php echo $entry_named; ?>" id="input-name" class="form-control" />
              <?php if ($error_name) { ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-banner"><?php echo $text_banner; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="width" value="<?php echo $width; ?>" placeholder="<?php echo $text_width; ?>" id="input-width" class="form-control" />
              <?php if ($error_width) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="height" value="<?php echo $height; ?>" placeholder="<?php echo $text_height; ?>" id="input-height" class="form-control" />
              <?php if ($error_height) { ?>

...
<div id="content">
    ...
    <div class="container-fluid">
	  ...
	  <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
		...
		<a onclick="location = '<?php echo $export; ?>'" class="btn btn-default"><span><?php echo $text_export; ?></span></a>
      </div>
    </div>
  </div>
      ...
      <div class="table-responsive">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><a href="<?php echo $email['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>

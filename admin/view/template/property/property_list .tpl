          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <thead>
                ...
                <tr>
								<td style="width: 1px;" class="text-center"><input type="checkbox"  name="selected[]" value="<?php echo $result['property_type_id']; ?>" /></td>
                  <td class="text-left"><?php echo $result['name']; ?> vcvcv</td>

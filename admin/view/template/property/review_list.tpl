          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-product"><?php echo $entry_property; ?></label>
                 <input type="text" name="filter_property_name" value="<?php echo $filter_property_name; ?>" placeholder="<?php echo $entry_property; ?>" id="input-name" class="form-control" />
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    <a href="<?php echo $sort_property; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_property; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_property; ?>"><?php echo $column_property; ?></a>
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
	...
	var url = 'index.php?route=property/review&token=<?php echo $token; ?>';

	var filter_property_name = $('input[name=\'filter_property_name\']').val();

	if (filter_property_name) {
		url += '&filter_property_name=' + encodeURIComponent(filter_property_name);
	}
...
<script type="text/javascript"><!--
$('input[name=\'filter_property_name\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'filter_property_name\']').val(item['label']);

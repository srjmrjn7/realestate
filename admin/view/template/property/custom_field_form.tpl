      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label"><?php echo $lable_name; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-type"><?php echo $lable_type; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group" id="display-value">
            <label class="col-sm-2 control-label" for="input-value"><?php echo $lable_value; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group" id="display-validation">
            <label class="col-sm-2 control-label" for="input-validation"><span data-toggle="tooltip" title="<?php echo $help_regex; ?>"><?php echo $lable_validation; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order"><span data-toggle="tooltip" title="<?php echo $help_sort_order; ?>"><?php echo $lable_sort_order; ?></span></label>
            <div class="col-sm-10">
          ...
          <table id="custom-field-value" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <td class="text-left required"><?php echo $lable_custom_value; ?></td>

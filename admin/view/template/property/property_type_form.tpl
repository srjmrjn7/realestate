              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } ?>
                    ...
                    <label class="col-sm-2 control-label" for="input-lname_title"><?php echo $entry_SEO_URL; ?></label>
										
                    <div class="col-sm-10">
                      <input type="text" name="lname_title" value="" placeholder="<?php echo $entry_SEO_URL;?>" id="input-lname_title" class="form-control"/>

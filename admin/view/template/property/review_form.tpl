    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-property"><span data-toggle="tooltip" title="<?php echo $help_product; ?>"><?php echo $entry_property; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="property" value="" placeholder="<?php echo $entry_property; ?>" id="input-property" class="form-control" />
              <input type="hidden" name="property_id" value="<?php echo $property_id; ?>" />
              <?php if ($error_property) { ?>
              <div class="text-danger"><?php echo $error_property; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
...
$('input[name=\'property\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'property\']').val(item['label']);

...
class ControlleragentOuragentview extends Controller {
 ...
 public function index() {
	 ...
	 $this->load->language('agent/viewagent');
		...
		$this->response->setOutput($this->load->view('agent/ouragentview',$data));

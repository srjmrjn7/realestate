<?php echo $header; ?>
	<div class="contact-map" style=" pointer-events: none;">
		<iframe src="<?php echo $maps; ?>" allowfullscreen></iframe>
	</div>
        ...
        <fieldset>
          <legend><?php echo $heading_title; ?></legend>
			<div class="form-group required">
				<div class="col-sm-6">
					<input type="text" name="name" value="<?php echo $name; ?>" id="input-name" class="form-control" placeholder="Name"/>
					<?php if ($error_name) { ?>
